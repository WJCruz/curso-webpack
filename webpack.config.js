...
module.exports = {
  ...
  output: {
    ...
    clean: true, // Limpia la carpeta dist de tener archivos antiguos
  },
  resolve: {
  ...
  plugins: [
    ...
    new Dotenv(), // permite leer las variables de entorno
    // new CleanWebpackPlugin(), // Limpia la carpeta dist de tener archivos antiguos
  ],
  optimization: {
    minimize: true,
    minimizer: [
